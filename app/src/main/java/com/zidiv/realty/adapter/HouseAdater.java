 ...
 */
public class HouseAdater extends BaseAdapter{
    private List<HouseInfoList.HouseInfo> list;
    private Context context;
    private LayoutInflater inflater;
    public HouseAdater(Context context, List<HouseInfoList.HouseInfo> list) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            view = inflater.inflate(R.layout.item_house_adapter, null);
            ...
            mViewHolder.houseSoujia = (TextView) view.findViewById(R.id.houseSoujia);
        ...
        if (SqliteBrowser.dataExists(context, "sell" + info.getId())) {
        ...
        mViewHolder.houseSoujia.setText(info.getHouseSoujia() + info.getHouseZhuJiaType());
