...
public class BrowserActivity extends BaseActivity implements XListView.IXListViewListener {
    ...
    public void initView() {
        ...
        tv_title.setText("我的浏览");
        iv_back = (ImageView) findViewById(R.id.back_image);
        iv_back.setVisibility(View.VISIBLE);

        gson = new Gson();
        houseAdater = new HouseAdater(context, houseInfoList);
        xListView = (XListView) findViewById(R.id.xListView);
        xListView.setPullRefreshEnable(true);
        xListView.setPullLoadEnable(true);
        xListView.setAdapter(houseAdater);
    ...
    private void getData(final String page) {
        String url = HttpUrls.HOUSE_BROWSER_LIST;
        ...
        MApplication.getMApplication().getHttpUtils().send(HttpRequest.HttpMethod.POST, url, params, new RequestCallBack<String>() {
            ...
            public void onSuccess(ResponseInfo<String> responseInfo) {
                ...
                if (infoList.getStatus().equals("1")) {
                    ...
                    houseAdater.notifyDataSetChanged();
                    onLoad();
